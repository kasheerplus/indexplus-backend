...
-- The issue: policies have circular dependency (users table checking users table)
-- Solution: Use a security definer function to bypass RLS when checking permissions
